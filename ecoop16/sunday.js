$(document).ready(function(){
	var colWidth = '220px' // 215 best A4 fit
	
	// do the dirty naughty stuff first
	$('#header-pmldc').text('PMLDC')
	...
	eventColors['doctoral'] = 'orange';
	eventColors['pmldc'] = 'blue';
	eventColors['live'] = 'green';
	eventColors['stop'] = 'yellow';
